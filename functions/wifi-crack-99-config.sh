...
while : ; do
    ...
    echo -ne "
        1 - REDE ALVO: \033[1;32m$SELECT_ALVO\033[0m \033[1;31m$SELECT_ALVO_STATUS\033[0m
    ...
    99) SELECT_BSSID_NAME="$(echo $SELECT_BSSID | sed 's/:/-/g')"
    echo "ALVO=\"$SELECT_ALVO\"
CHANNEL=\"$SELECT_CHANNEL\"
BSSID=\"$SELECT_BSSID\"
STATION=\"$SELECT_STATION\"
" > "$CONFIG_ATTACK_DIR/$SELECT_ALVO"_"$SELECT_BSSID_NAME" && SELECT_SAVE_FILE="Ultimo arquivo salvo em \033[1;32m${CONFIG_ATTACK_DIR}/${SELECT_ALVO}_${SELECT_BSSID_NAME}\033[0m" ;;
    0) break ;;
    *) echo "INVALID OPTION!!!"
    esac
